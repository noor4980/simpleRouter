...
function UserDetails({ list = []}) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <button className="px-6 py-2 mt-4 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400" onClick={() => navigate("/")}
      >Go Back</button>
      <button
          className="px-6 py-2 mt-4 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400"
          onClick={() => navigate("/productdetails")}
